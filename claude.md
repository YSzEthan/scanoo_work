...
**功能**：
- 從 Supabase 資料庫中取得所有「想法」紀錄。

- 將這些想法以卡片(Card)形式顯示在頁面上。

- 每張卡片需顯示想法的內容與建立時間並且提供編輯與刪除的按鈕。

- 新增、修改或刪除時需要跳出通知。

**提交新想法**:

- 頁面上需有一個簡單的表單並支援markdown,並且可以文字輸入填寫想法內容,還要一個「送出」按鈕。

- 送出新想法後,資訊需儲存於 Supabase 資料庫。

- 送出成功後,新的卡片需立即顯示在想法清單的頂部,並無須重新整理整個頁面。


### 當有code review需求時使用以下內容進行
```
Role Definition
